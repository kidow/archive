...
Storybook [link](https://components.kidow.me/?path=/story/feedback--notice)
...
```tsx title="components/Notice/index.tsx"
...
const Notice: FC<Props> = ({ type, content, caption }) => {
  return (
    <div
      className={classnames(
        ...
        !!type
          ...
          : 'border-gray-300 border-l-gray-500 bg-gray-50',
        {
    ...
    >
      ...
      <div
        className={classnames('text-sm', !!type ? 'flex-1' : 'text-gray-700', {
