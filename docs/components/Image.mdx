Storybook [link](https://components.kidow.me/?path=/story/data-display--input)
            ...
            <div className="flex min-h-screen items-end justify-center p-0 text-center md:block">
              ...
              <div
                className={classnames(
                  `my-8 inline-block w-full transform overflow-hidden align-middle shadow-xl transition-all sm:px-8`
                )}
              >
                <img
                  {...props}
