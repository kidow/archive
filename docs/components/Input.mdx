...
Storybook [link](https://components.kidow.me/?path=/story/inputs--input)
      ...
      >
        ...
        <input
          ...
          className={classnames(
            'bg-white',
            isBaseWord
              ? 'mx-1 w-full flex-1 border-0 focus:outline-none'
              : 'block',
            {
        ...
        {!!props.placeholder && (
          <label
            ...
            className={classnames(
              'absolute -top-6 max-w-[calc(100%-24px)] cursor-text select-none truncate text-gray-600 transition-all peer-placeholder-shown:text-gray-400 peer-focus:left-0 peer-focus:max-w-full peer-focus:cursor-default peer-focus:text-gray-600',
